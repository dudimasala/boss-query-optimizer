...
//---------------------------------------------------------------------------
#ifndef GPOS_CPhysicalMalharAgg_H
#define GPOS_CPhysicalMalharAgg_H
...
//
//---------------------------------------------------------------------------
class CPhysicalMalharAgg : public CPhysicalAgg
{
private:
	// private copy ctor
	CPhysicalMalharAgg(const CPhysicalMalharAgg &);

public:
	// ctor
	CPhysicalMalharAgg(CMemoryPool *mp, CColRefArray *colref_array,
	...
	PopConvert(COperator *pop)
	{
		...
		return reinterpret_cast<CPhysicalMalharAgg *>(pop);
	}

};	// class CPhysicalMalharAgg
