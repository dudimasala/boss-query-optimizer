...
//
//---------------------------------------------------------------------------
CXformGbAgg2MalharAgg::CXformGbAgg2MalharAgg(CMemoryPool *mp)
...
//
//---------------------------------------------------------------------------
CXformGbAgg2MalharAgg::CXformGbAgg2MalharAgg(CExpression *pexprPattern)
...
CXformGbAgg2MalharAgg::Exfp(CExpressionHandle &exprhdl) const
{
...
//---------------------------------------------------------------------------
void
CXformGbAgg2MalharAgg::Transform(CXformContext *pxfctxt, CXformResult *pxfres,
							   CExpression *pexpr) const
{
	...
	CExpression *pexprAlt = GPOS_NEW(mp) CExpression(
		mp,
		GPOS_NEW(mp) CPhysicalMalharAgg(
...
//---------------------------------------------------------------------------
BOOL
CXformGbAgg2MalharAgg::FApplicable(CExpression *pexpr) const
{
